...
abstract class ByteValue extends FloatValue
{
    ...
    {
        return parent::fromFloat($value * pow(1024, $unit - self::B));
    }

    private function to(int $unit): float
    {
        return parent::toFloat() * pow(1024, self::B - $unit);
    }

    public static function fromFloat(float $value): static
    {
        return self::from(self::checkUnit(self::inputUnit()), $value); // TODO: Change the autogenerated stub
    }
